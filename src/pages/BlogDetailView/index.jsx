  ...
  return (
    <div className="blog-detail">
      <div className="blog-title">
        ...
        <Link to="/secondLayout/blog" className="back-to-blog">
          Back to Blog
        </Link>
      </div>
      <div className="blog-content">
        <img src={BlogDetailImage} alt="Blog detail" />
        <div className="blog-meta">
          <span>109k views</span> • <span>March 10, 2020</span>
        </div>
        <p>
          ...
          velit interdum eu. Vestibulum hendrerit id dolor eu scelerisque.
          Phasellus ex dui, consequat nec feugiat eu, dapibus eget ante. Sed
          sodales interdum dui, at euismod mi feugiat hendrerit. Suspendisse
          auctor libero in tempor mollis. Nulla et dolor velit. Aliquam sit amet
          luctus quam.
        </p>
        <h2>Why did you decide to teach on Cursus?</h2>
        <p>
          ...
          tristique quam, non dignissim sapien pharetra ultrices. Cras non ante
          non velit mollis mollis. Pellentesque habitant morbi tristique
          ...
          enim quis diam congue dictum et vitae dui. Nulla tortor orci, luctus a
          pretium vel, ultrices porta nisl.
        </p>
        <p>
          Etiam lobortis dictum tincidunt. Interdum et malesuada fames ac ante
          ipsum primis in faucibus. Suspendisse ultricies efficitur dui,
          suscipit tempus elit condimentum quis. Duis sed vestibulum tortor,
          eget cursus odio.
        </p>
        <h2>
          Did you have any prior on- or offline teaching experience prior to
          publishing your first Cursus course?
        </h2>
        <p>
        ...
        <h2>What are the most rewarding aspects of teaching on Cursus?</h2>
        <p>
      ...
      <div className="pagination">
        <a href="#" className="previous">
          &laquo; Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </a>
        <a href="#" className="next">
          Vestibulum vulputate nulla quis dignissim ultricies. &raquo;
        </a>
      </div>
    </div>
  );
