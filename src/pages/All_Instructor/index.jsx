...
const All_Instructors = () => {
    ...
    const all_instructor = useSelector(
        (state) => state.myProfile.all_instructor
    );
    const account = useSelector((state) => state.user.account);
    const Instructor = useSelector((state) => state.myProfile.instructor);
                                        ...
                                        <div className="all_instructor_infor">
                                            ...
                                            <div className="all_instructor_infor_content">
                                                <div className="all_instructor_infor_content_detail">
                                                    <a
                                                        href="#"
                                                        className="all_instructor_infor_name"
                                                    >
                                                        {instructor.userName}
