...
import "./index.scss";
function CRC_add_lecture_embedded() {
    return (
        <div className="crc_add_lecture_embedded crc_add_lecture_externalURL">
            <div className="externalURL_input-title">Embedded Code*</div>
            <div className="externalURL_input-wrap  embedded_textarea-wrap">
                <textarea
                    type="text"
                    name=""
                    id=""
...
export default CRC_add_lecture_embedded;
