...
import "./index.scss";
function CRC_add_lecture_vimeo() {
    return (
        <div className="crc_add_lecture_vimeo crc_add_lecture_externalURL">
            <div className="externalURL_input-title">Vimeo URL*</div>
...
export default CRC_add_lecture_vimeo;
