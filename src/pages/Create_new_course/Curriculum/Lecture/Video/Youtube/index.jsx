...
import "./index.scss";
function CRC_add_lecture_youtube() {
    return (
        <div className="crc_add_lecture_youtube crc_add_lecture_externalURL">
            <div className="externalURL_input-title">Youtube URL*</div>
...
export default CRC_add_lecture_youtube;
