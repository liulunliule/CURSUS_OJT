            ...
            <div className="row">
              <div className="col-xl-4 col-lg-6 col-md-6">
                <div className="studio-dashboard-section studio-dashboard-mt-50">
                          ...
                          <div className="studio-dashboard-course-1">
                            ...
                            <div className="studio-dashboard-course-content">
                              ...
                              <div className="studio-dashboard-item">
                                ...
                                <a href="#" className="studio-dashboard-50">
                                  See comments ({item.comments})
                                </a>
                                <a href="#" className="studio-dashboard-50">
                                  See Reviews ({item.reviews})
                                </a>
                              </div>
                            </div>
                          </div>
                  ...
                  <div
                    className="studio-dashboard-owl-nav button_test"
                    style={{
                      top: "15px",
                      right: 0,
                    }}
              ...
              <div className="col-xl-4 col-lg-6 col-md-6">
                <div className="studio-dashboard-section studio-dashboard-mt-50">
                  ...
                  <div className="button-news" style={{ top: "43px" }}>
                    <button
                      type="button"
                            ...
                            (itemProfileAnalytics, index) => (
                              <div key={index}>
                                ...
                                <div class="studio-dashboard-view">
                                  ...
                                  <div class="studio-dashboard-course-content-right">
                                    {itemProfileAnalytics.purchased.count}
                                    <span class="studio-dashboard-course-content-analyics">
                                      <i class="uil uil-top-arrow-from-top"></i>
                                      {
                                        itemProfileAnalytics.purchased
                                          .percentageChange
                                      }
                                      %
                                    </span>
                                ...
                                <div class="studio-dashboard-view">
                                  ...
                                  <div class="studio-dashboard-course-content-right">
                                    {itemProfileAnalytics.enroll.count}
                                    <span class="studio-dashboard-course-content-analyics">
                                      <i class="uil uil-top-arrow-from-top"></i>
                                      {
                                        itemProfileAnalytics.enroll
                                          .percentageChange
                                      }
                                      %
                                    </span>
