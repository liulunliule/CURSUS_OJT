...
function SidebarFrontend() {
    ...
    console.log("Check account: ", account.id);
    return (
            ...
            <div className="select_Side1">
                <Link className="Link_SideBar" to="/">
                    <div className="select_Home">
                        <img
                            className="HomeLogo_SideBar"
                            src={HomeLogo_SideBar}
                            alt=""
                        />
                ...
                <Link className="Link_SideBar" to="/LiveStreams">
                    <div className="select_LiveSteam">
                        <img
                            ...
                            alt=""
                        />
                        <span className="select_LiveSteam__title">
                            Live Streams
                        </span>
                    </div>
                </Link>
                    ...
                    <summary className="select_Categories">
                        <div className="wrapperCategories">
                            <img
                                ...
                                alt=""
                            />
                            <span className="select_Explore__title">
                                Categories
                            </span>
                        </div>
                        <img
                ...
                <Link className="Link_SideBar" to={`/saved_courses`}>
                    <div className="select_SavedCourses">
                        <img
                            ...
                            alt=""
                        />
                        <span className="select_SavedCourses__title">
                            Saved Courses
                        </span>
                    </div>
                </Link>
                ...
                <div className="select_ListAvatar">
                    ...
                    <Link to="/other_instructor_view" className="Link_SideBar">
                        <div className="wrapper_avatar2_SideBar">
                            <img
                                className="avatar2_SideBar"
                                src={avatar2_SideBar}
                                alt=""
                            />
                            <span className="nameOfAvatar2_SideBar">
                                Jassica William
                            </span>
                            <span className="redDot_Avatar_SideBar"></span>
                        </div>
                    ...
                    <Link to="/all_instructor" className="Link_SideBar">
                        <div className="addInstructor_SideBar">
                            <img
                                ...
                                alt=""
                            />
                            <span className="AddInstructor__title">
                                Browse Instructors
                            </span>
                        </div>
                    </Link>
            ...
            <div className="select_Side3">
                ...
                <Link className="Link_SideBar" to="/help">
                    <div className="wrapper_SupportFunction_Help_SideBar">
                        <img
                            className="HelpLogo_SideBar"
                            src={HelpLogo_SideBar}
                            alt=""
                        />
                ...
                <Link className="Link_SideBar" to="/report_history_page">
                    <div className="wrapper_SupportFunction_ReportHistory_SideBar">
                        <img
                            ...
                            alt=""
                        />
                        <span className="ReportHistory_Title">
                            ReportHistory
                        </span>
                    </div>
                </Link>
            ...
            <div className="select_Side4">
                ...
                <div className="Footer_Content_SideBar">
                    <p className="P_Footer_SideBar">
                        © 2024{" "}
                        <strong className="Strong_Footer_SideBar">
                            Cursus
                        </strong>
                        . All Rights Reserved.
                    </p>
...
export function SideBarInstructorDashboardDemo() {
    ...
    return (
        <div
            className={`SideBarInstructorDashboardDemo ${
                isShowAll ? "active" : ""
            }`}
        >
...
export function SideBarStudentDashboardDemo() {
    ...
    return (
        <div
            className={`SideBarStudentDashboardDemo ${
                isShowAll ? "active" : ""
            }`}
        >
